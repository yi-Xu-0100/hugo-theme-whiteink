$(document).ready(function () {
  $(window).scroll(function () {
    60 < $(window).scrollTop() ? $('.gotop').show() : $('.gotop').hide();
  }),
    $('.gotop').click(function () {
      $('html, body').animate({ scrollTop: 0 }, 300);
    }),
    $('#avatar-img').mouseenter(function () {
      $('#avatar-img').removeClass('zoomIn'), $('#avatar-img').addClass('headShake');
    }),
  ...
  clipboard.on('success', function (e) {
    ...
    clipboard.on('error', function (e) {
      console.error('Action:', e.action), console.error('Trigger:', e.trigger), alert('error!');
    });
});
